...
namespace game
{
	namespace config
	{
		...
		static const int DEFAULT_GAME_UPDATE_SPEED	= 150;
		...
		static const int AUTOMATE_SNAKE_INPUT_SPEED = 10;
		static const int AUTOMATE_SNAKE_INPUT_SPEED_STEP = 100;
		static const int AUTOMATE_MODE_UPDATE_SPEED = 200;
